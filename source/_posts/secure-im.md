...
3. Android 版：下载页面为 https://signal.org/android/apk/ ，目前最新版为 https://updates.signal.org/android/Signal-Android-website-prod-universal-release-5.1.9.apk （手机上请复制粘贴到浏览器中打开，以下载安装）。
